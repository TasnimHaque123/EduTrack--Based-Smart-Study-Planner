...
1. **Clone the repository:**
   ```bash
   git clone [https://github.comTasnimHaque123/EduTrack--Based-Smart-Study-Planner.git](https://github.com/TasnimHaque123/EduTrack--Based-Smart-Study-Planner.git)
   cd edutrack
